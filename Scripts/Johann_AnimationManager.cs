...
public class Johann_AnimationManager : MonoBehaviour
{
    ...
    public static Johann_AnimationManager Instance { get; private set; }
    private void Awake()
    {
        Instance = this;
    }
    ...
    //    {
    //        if (currentAnimation != DialogueManager.Instance.kandinskyAnimationChange)
    //        {
    //            currentAnimation = DialogueManager.Instance.kandinskyAnimationChange;
